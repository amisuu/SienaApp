...
export class OfferComponent {
  ...
  contentText2 = 'To regularne spotkania terapeutyczne trwające około 45 minut (czas trwania dostosowany jest do indywidualnych potrzeb i możliwości pacjenta). Najczęściej odbywają się raz w tygodniu, ale częstotliwość zawsze jest dostosowana do indywidualnych potrzeb i możliwości pacjenta. Każde spotkanie to zestaw starannie dobranych ćwiczeń, które wspierają rozwój mowy, komunikacji oraz innych funkcji powiązanych.';
